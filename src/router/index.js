      ...
      children: [
        {
          ...
          name: 'tema1',
          component: () =>
            import(/* webpackChunkName: "tema2" */ '../views/Tema1.vue'),
        },
        {
          path: 'tema2',
          name: 'tema2',
        ...
        },
        {
          ...
          name: 'tema4',
          component: () =>
            import(/* webpackChunkName: "tema2" */ '../views/Tema4.vue'),
        },
        {
          path: 'tema5',
          name: 'tema5',
          component: () =>
            import(/* webpackChunkName: "tema2" */ '../views/Tema5.vue'),
        },
        {
          path: 'tema6',
          name: 'tema6',
          component: () =>
            import(/* webpackChunkName: "tema2" */ '../views/Tema6.vue'),
        },
        {
          path: 'tema7',
          name: 'tema7',
          component: () =>
            import(/* webpackChunkName: "tema2" */ '../views/Tema7.vue'),
        },
        {
          path: 'tema10',
          name: 'tema10',
          component: () =>
            import(/* webpackChunkName: "tema1" */ '../views/Tema10.vue'),
        },
      ],
    },
    {
