export default {
  ...
  menuPrincipal: {
    menu: [
      ...
      },
      {
        ...
        numero: '3',
        titulo:
          '<font style="font-style: italic">Ebooks, e-magazines</font>, presentaciones, catálogos, <font style="font-style: italic">e-cards</font>',
        desarrolloContenidos: true,
      },
      {
        nombreRuta: 'tema4',
  ...
  creditos: {
    ...
    contenidoInstruccional: [
      ...
      {
        nombre: 'Guillermo Eduardo Gonzáles',
