...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    #t_6_1.titulo-segundo.color-acento-contenido
      h2 6.1 Experiencia de usuario: UX
    ...
    .row.mb-3
      .col-lg-4.d-flex
        div.p-3.tema-6-div1
          p.color-1.text-center.mb-3 <b>Ejemplo 1</b>
          p.mb-0.text-center En el primer ejemplo encontramos un botón que nos permite hacer una compra o una interacción, acá encontramos UI.
    ...
    .row(style="position: relative; top:-30px")
      ...
      .col-lg-4
        figure.mb-0(style="position: relative; left:-30px")
    ...
    .row.mb-5(style="background-color: #F0F4F7").bg--ligthblue
      .col-lg-12.pt-5
        SlyderE(indicadores="derecha")
          ...
          .row.mb-0
            .col-lg-6
              h3.mb-5.color-1 Satisfacer a plenitud sus necesidades
              p.mb-0 La creación de ese producto debe estar sujeto a una gran calidad y al control de los tiempos de desarrollo, estableciendo criterios respecto a la estructura, definición y cumplimiento de las metas, el conocimiento del mercado objetivo, así como de los usuarios, los patrocinadores publicitarios, el diseño del contenido, la facilidad de navegación, el diseño atractivo, la identidad corporativa entre otros aspectos.
            .col-lg-6
